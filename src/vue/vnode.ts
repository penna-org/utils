...
export function getSlotsProps<S extends object, P extends object, K extends keyof S, KP extends keyof P>(slots: S, props: P, key: K | KP, ...args: any[]) {
...
export function hasSlotProps<S extends object, P extends object, K extends keyof S, KP extends keyof P>(slots: S, props: P, key: K | KP) {
  if (key in slots && slots[key as K])
    return true
